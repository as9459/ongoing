...
public class FenEntreprise extends JInternalFrame {
	...
	private GestionFenEntreprise gestionClic;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FenEntreprise frame = new FenEntreprise(new FenetrePrincipale());
	 ...
	 * Create the frame.
	 */
	public FenEntreprise(FenetrePrincipale parent) {
		this.parent = parent;  
        ...
        this.gestionClic = new GestionFenEntreprise(this, this.parent);			
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"SIREN","Nom", "SERVES", "Adresse", "CP", "IBAN", "Ville", "Email", "Telephone"
			}
		));
		...
		lblNewLabel = new JLabel("Liste des entreprises");
	...
	public JTable getTableEntreprise() {
		return this.table;
	}
